...
if __name__ == "__main__":
    ...
    multiply = Button(gui, text="X", fg="black", bg='grey', command=lambda: press('*'), height=1, width=7)
    multiply.grid(row=4, column=3)
    divide = Button(gui, text="/", fg="black", bg='grey', command=lambda: press('/'), height=1, width=7)
    divide.grid(row=5, column=3)
    equal = Button(gui, text="=", fg="black", bg='grey', command=equal_press, height=1, width=7)
